...
extern Mtx *g_CameraPerspectiveMtx;
...
extern uint8_t g_NVBGBrightness;
extern uint8_t g_NVPropBrightness;
extern uint8_t g_NVPropHighlight;
...
extern PakPfs g_Pfses[MAX_PLAYERS];
...
extern float g_TransformedVertices[16 * 3];
