...
bool objTestChrHit(struct chrdata *chr, struct coord *arg1, struct coord *arg2, struct coord *arg3, float arg4, struct coord *arg5, struct coord *arg6, struct coord *arg7, struct coord *arg8, float *arg9);
...
void ojbBBoxTransformBottomVertices(struct modelrodata_bbox *bbox, float realrot[3][3], struct coord *pos, struct coord *vertices);
...
bool objTestShieldHit(struct model *model, struct modelnode *node, struct coord *arg2, struct coord *arg3, struct hitthing *arg4, int *arg5, struct modelnode **arg6);
