...
Gfx *bviewCopyPixels(Gfx *gdl, u16 *fb, int top, uint32_t tile, int arg4, float arg5, int left, int width);
...
Gfx *bviewDrawFisheye(Gfx *gdl, uint32_t colour, uint32_t alpha, int shuttertime60, s8 startuptimer60, u8 hit);
Gfx *bviewDrawEyespySideRect(Gfx *gdl, int *points, u8 r, u8 g, u8 b, u8 alpha);
