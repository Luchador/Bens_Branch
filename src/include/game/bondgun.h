...
void bgun0f09ed2c(struct defaultobj *obj, struct coord *coord, Mtx *arg2, struct coord *velocity, Mtx *arg4);
...
void bgunUpdateGangsta(struct hand *hand, int handnum, struct coord *arg2, struct weaponfunc *funcdef, Mtx *rotMtx, Mtx *baseMtx);
...
void bgunMuzzleFlash(struct hand *hand, struct weapon *weapondef, struct modeldef *modeldef, struct weaponfunc *funcdef, int maxburst, uint8_t *allocation, int weaponnum, bool **arg7, int mtxindex, Mtx *arg9, Mtx *arg10);
...
void bgunUpdateAmmoBar(struct abmag *abmag, int remaining, int capacity, int height);
